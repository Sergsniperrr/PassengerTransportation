...
public class BusView : MonoBehaviour
{
    ...
    public void InitializeData(ParticleSystem sparks) =>
        _sparks = sparks != null ? sparks : throw new NullReferenceException(nameof(sparks));
    ...
    {
        _sparks.transform.position = transform.position + _sparksShiftPosition;
        _sparks.Play();
    }
    ...
    private Vector3 CalculateSparksPosition()
    {
        ...
        int stepsCount = _loader.Count / trippleDevider - 1;
